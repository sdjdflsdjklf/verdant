...
export const CONFIG_SCHEMA: ConfigFieldDescriptor[] = [
  ...
  { key: "siteTitle", label: "Site Title", description: "Your garden's title", type: "string", defaultValue: "My Digital Garden", required: false },
  { key: "siteDescription", label: "Site Description", description: "SEO description", type: "string", defaultValue: "A digital garden powered by Garden", required: false },
